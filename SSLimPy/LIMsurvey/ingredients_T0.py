...
def T3111_kernel(k1, k2, b1k1, b1k2, b2k2, bG2k2, b3k2, bdG2k2, bG3k2, bDG2k2):
    ...
    return (
        ...
        * b1k2
        * (
            3264 * b2k2 * Power(k1, 5) * Power(k2, 3)
            + 1008 * b3k2 * Power(k1, 5) * Power(k2, 3)
            - 2688 * bdG2k2 * Power(k1, 5) * Power(k2, 3)
            - 1344
            * bG3k2
            * Power(k1, 3)
            * k2
            * (2 * Power(k1, 4) - 3 * Power(k1, 2) * Power(k2, 2) + Power(k2, 4))
            + 168
            * bG2k2
            * Power(k1, 2)
            * Power(k2, 2)
            ...
            * (
                ...
                * k1
                * k2
                * (Power(k1, 2) + Power(k2, 2))
                * (
                    3 * Power(k1, 4)
                    - 14 * Power(k1, 2) * Power(k2, 2)
                    + 3 * Power(k2, 4)
                )
            ...
            * (
                ...
                * (
                    -21 * Power(k1, 6)
                    + 50 * Power(k1, 4) * Power(k2, 2)
                    - 79 * Power(k1, 2) * Power(k2, 4)
                    + 6 * Power(k2, 6)
                )
                - 3
                * Power(Power(k1, 2) - Power(k2, 2), 3)
                * (7 * Power(k1, 2) + 2 * Power(k2, 2))
                * Logq
            )
        )
    ) / (6048.0 * Power(k1, 5) * Power(k2, 3))
...
def T3111_s_k2ok1(k1, k2, b1k1, b1k2, b2k2, bG2k2, b3k2, bdG2k2, bG3k2, bDG2k2):
    ...
    return (
        ...
        * (
            ...
            - 840 * bdG2k2
            - 61 * b1k2 * Power(eps, 2)
            - 384 * bDG2k2 * Power(eps, 2)
            - 840 * bG2k2 * (1 + 2 * Power(eps, 2))
            - (420 * bG3k2 * (2 - 3 * Power(eps, 2) + Power(eps, 4))) / Power(eps, 2)
        )
    ) / 1890.0
...
def T3111_s_k1ok2(k1, k2, b1k1, b1k2, b2k2, bG2k2, b3k2, bdG2k2, bG3k2, bDG2k2):
    ...
    return (
        ...
        * (
            ...
            + 2205 * b3k2
            - 5880 * bdG2k2
            + b1k2 * (812 - 735 / Power(eps, 2) - 564 * Power(eps, 2))
            + 1176 * bG2k2 * (-15 + 2 * Power(eps, 2))
            + 384 * bDG2k2 * (-7 + 3 * Power(eps, 2))
            - (2940 * bG3k2 * (1 - 3 * Power(eps, 2) + 2 * Power(eps, 4)))
            / Power(eps, 2)
        )
    ) / 13230.0
        ...
        * (
            ...
            * (
                ...
                * (
                    ...
                    * np.power(k1, 2)
                    * np.power(k2, 3)
                    + 3 * (1 + an) * (2 + 7 * an) * k1 * np.power(k2, 4)
            ...
            * (
                ...
                * (
                    ...
                    * np.power(k1, 3)
                    * np.power(k2, 3)
                    + (-1392 + an * (-340 + an * (478 + 7 * an * (30 + 7 * an))))
                    * np.power(k1, 2)
                    * np.power(k2, 4)
            ...
            * (
                ...
                * (
                    ...
                    + (6 + an * (4 + an)) * np.power(k1, 2) * np.power(k2, 2)
...
def T2211_A_s_k2ok1(k1, k2, b1k1, b1k2, b2k2, bG2k2, an):
    ...
    return (
        ...
        * (
            42 * b2k2
            + (-4 * b1k2 + 7 * an * (1 + an) * b2k2 - 112 * bG2k2) * np.power(eps, 2)
        )
    ) / 168.0
...
def T2211_A_s_k1ok2(k1, k2, b1k1, b1k2, b2k2, bG2k2, an):
    ...
    return (
        ...
        * (
            ...
            * Power(bG2k2, 2)
            * Power(k2, an)
            * (14 + (-4 + an) * (1 + an) * Power(eps, 2))
            - 10976
            * b2k2
            * bG2k2
            * Power(k2, an)
            * (10 + (-2 + an) * (1 + an) * Power(eps, 2))
            + 6860
            * Power(b2k2, 2)
            * Power(k2, an)
            * (6 + an * (1 + an) * Power(eps, 2))
            + (
                Power(b1k2, 2)
                * Power(k2, an)
                * (
                    13720
                    + 28 * (1138 + 7 * an * (-115 + 21 * an)) * Power(eps, 2)
                    + (-4 + an)
                    * (4026 + an * (4327 + 7 * an * (-314 + 35 * an)))
                    * Power(eps, 4)
                )
            )
            / Power(eps, 2)
...
def T2211_X_kernel(k1, k2, b1k1, b2k1, bG2k1, b1k2, b2k2, bG2k2, an):
    ...
    return -(
        ...
        * (
            ...
            * (
                Power(k1 + k2, 2 + an)
                * (Power(k1, 2) - (2 + an) * k1 * k2 + Power(k2, 2))
                - Power(k1 - k2, 2)
                * (Power(k1, 2) + (2 + an) * k1 * k2 + Power(k2, 2))
                * Power(Abs(k1 - k2), an)
            )
            ...
            * (
                ...
                * (
                    (8 + 7 * an) * Power(k1, 3)
                    - (8 + 15 * an + 7 * Power(an, 2)) * Power(k1, 2) * k2
                    + 20 * (1 + an) * k1 * Power(k2, 2)
                    - 20 * Power(k2, 3)
                )
                - (k1 - k2)
                * (
            ...
            * (
                ...
                * (
                    20 * Power(k1, 3)
                    - 20 * (1 + an) * Power(k1, 2) * k2
                    + (8 + 15 * an + 7 * Power(an, 2)) * k1 * Power(k2, 2)
                    - (8 + 7 * an) * Power(k2, 3)
                )
                - (k1 - k2)
                * (
            ...
            * (
                ...
                * (
                    3 * Power(k1, 4)
                    - 3 * (2 + an) * Power(k1, 3) * k2
                    + (6 + 4 * an + Power(an, 2)) * Power(k1, 2) * Power(k2, 2)
                    - 3 * (2 + an) * k1 * Power(k2, 3)
                    + 3 * Power(k2, 4)
                )
                - Power(k1 - k2, 2)
                * (
            ...
            * (
                ...
                * (
                    3 * (2 + 7 * an) * Power(k1, 5)
                    - 3 * (2 + 9 * an + 7 * Power(an, 2)) * Power(k1, 4) * k2
                    + (42 + 51 * an + 16 * Power(an, 2) + 7 * Power(an, 3))
                    * Power(k1, 3)
                    * Power(k2, 2)
                    - (42 + 89 * an + 47 * Power(an, 2)) * Power(k1, 2) * Power(k2, 3)
                    + 120 * (1 + an) * k1 * Power(k2, 4)
                    - 120 * Power(k2, 5)
                )
                - (k1 - k2)
                * (
            ...
            * (
                ...
                * (
                    120 * Power(k1, 5)
                    - 120 * (1 + an) * Power(k1, 4) * k2
                    + (42 + 89 * an + 47 * Power(an, 2)) * Power(k1, 3) * Power(k2, 2)
                    - (42 + 51 * an + 16 * Power(an, 2) + 7 * Power(an, 3))
                    * Power(k1, 2)
                    * Power(k2, 3)
                    + 3 * (2 + 9 * an + 7 * Power(an, 2)) * k1 * Power(k2, 4)
                    - 3 * (2 + 7 * an) * Power(k2, 5)
                )
                - (k1 - k2)
                * (
            ...
            * (
                ...
                * (
                    ...
                    + (-120 + 676 * an + 250 * Power(an, 2) + 189 * Power(an, 3))
                    * Power(k1, 4)
                    * Power(k2, 2)
                    - an
                    * (-80 + 816 * an + 210 * Power(an, 2) + 49 * Power(an, 3))
                    * Power(k1, 3)
                    * Power(k2, 3)
                    + (-120 + 676 * an + 250 * Power(an, 2) + 189 * Power(an, 3))
                    * Power(k1, 2)
...
def T2211_X_s_k2ok1(k1, k2, b1k1, b2k1, bG2k1, b1k2, b2k2, bG2k2, an):
    ...
    return (
        ...
        * b1k2
        * (
            10 * (-8 + 21 * an) * b1k1 * b1k2 * Power(k1, an) * Power(eps, 2)
            - 7
            * (-2 + an)
            * (1 + an)
            * (-27 + 7 * an)
            ...
            * Power(eps, 2)
            ...
            + Power(k1, an)
            * (
                -70 * b2k2 * ((-13 + 7 * an) * b1k1 - 21 * b2k1 + 28 * bG2k1)
                - 70 * b1k2 * (b2k1 + 4 * bG2k1) * Power(eps, 2)
                + 49
                * (1 + an)
                * b2k2
                * (5 * an * b2k1 + 8 * bG2k1 - 4 * an * bG2k1)
                * Power(eps, 2)
                + 392 * (-5 * b2k1 + 8 * bG2k1) * bG2k2 * Power(eps, 2)
            )
        )
    ) / 5880.0
...
def T2211_X_squeezed(k1, b1, b2, bG2, an):
    ...
    return (
        ...
        * Power(b1, 2)
        * (
            (1016 + 7 * an * (-10 + 7 * an)) * Power(b1, 2)
            - 28 * (6 + an) * (-12 + 7 * an) * b1 * b2
            + 196 * (4 + an) * (6 + an) * Power(b2, 2)
            + 112 * (-38 + 7 * an) * b1 * bG2
            - 1568 * (6 + an) * b2 * bG2
            + 6272 * Power(bG2, 2)
        )
